...
// configuration step. It creates a namespace called `fltk_tetris`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", fltk_tetris::cmake::project_name, fltk_tetris::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", fltk_tetris::cmake::project_version);
      return EXIT_SUCCESS;
    }
